            ...
            <div className="flex flex-col gap-1">
              <div className="flex  items-center gap-2 ">
                ...
                <div className="flex  flex-col max-w-[70%]">
                  <p className="font-bold">{profesional?.address?.streetName ? `${profesional.address?.streetName} ${profesional.address?.streetNumber}, ${profesional.address?.city}, ${profesional.address?.state ? profesional.address?.state + ", " : ""}${profesional.address?.country}` : ""}</p>
                </div>
              </div>
              <div className="flex  items-center gap-2 ">
