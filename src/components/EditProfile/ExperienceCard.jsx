...
const formatExperienceDates = (experience) => {
  ...
  const startFormatted = capitalizeFirstLetter(format(startDate, 'MMM. yyyy', { locale: es }))
  ...
  return (
    <div className="flex flex-col gap-1 rounded-sm bg-[#EBF7FB] py-2 px-3 w-full">
      <div className="flex items-center gap-2 justify-between">
        ...
        <span className="text-sm text-nowrap">{formatExperienceDates(experience)}</span>
      </div>
